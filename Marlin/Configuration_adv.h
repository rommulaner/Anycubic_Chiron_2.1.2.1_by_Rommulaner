 ...
 */
#if ANY(CHIRON_CLASSIC_JERK_ADAPTIVE_STEP_SMOOTHING, \
        CHIRON_CLASSIC_JERK_S_CURVE_ADAPTIVE_STEP_SMOOTHING, \
        CHIRON_CLASSIC_JERK_TMC2208_STANDALONE_ADAPTIVE_STEP_SMOOTHING, \
        CHIRON_CLASSIC_JERK_TMC2208_STANDALONE_S_CURVE_ADAPTIVE_STEP_SMOOTHING, \
        CHIRON_LINEAR_ADVANCE_ADAPTIVE_STEP_SMOOTHING, \
 ...
 */
  ...
  #define MINIMUM_STEPPER_PRE_DIR_DELAY 15000
...
#elif HAS_DRIVER(A5984) || HAS_DRIVER(A4988)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     40  // was 20 (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  40  // was 15 (mm/s) Load filament feedrate. This can be pretty fast.
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY       3000  // was 3000 (ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH        15  // was 0 (mm) An unretract is done, then this length is purged.
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE       5  // was 25 (mm/s) feedrate to purge before unload
